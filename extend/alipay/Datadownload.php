...
require_once dirname ( __FILE__ ).'/pay/service/AlipayWapPayTradeService.php';
require_once dirname ( __FILE__ ).'/pay/buildermodel/AlipayDataDataserviceBillDownloadurlQueryContentBuilder.php';
